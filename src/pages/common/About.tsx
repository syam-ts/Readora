...
const About: React.FC = () => {
  return (
   <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 nunito-regular">
  <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-white">About Readora</h1>
  ...
  <div className="mt-10">
    <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-white">Join the REadora Community</h2>
    <p className="text-base sm:text-lg leading-relaxed">
